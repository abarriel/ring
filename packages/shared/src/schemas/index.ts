...
export const UserSchema = z.object({
  ...
  sessionToken: z.string().uuid().nullable(),
...
export const CreateRingImageSchema = RingImageSchema.omit({ id: true })
...
export type CreateRingImage = z.infer<typeof CreateRingImageSchema>
